...
# Testing program
student1 = Student('Zubkov', 'Alksey', 'male')
student2 = Student('Smirnova', 'Elena', 'female')
...
lector1 = Lecturer('Oleg', 'Gejin')
lector2 = Lecturer('Evgeniy', 'Malikov')
...
reviewer1 = Reviewer('Misha', 'Vologodskiy')
reviewer2 = Reviewer('Roman', 'Sinikov')
...
reviewer1.rate_hw(student1, 'Django', 5)
reviewer1.rate_hw(student1, 'Django', 4)
reviewer2.rate_hw(student2, 'API', 4)
reviewer2.rate_hw(student2, 'Django', 3)
...
student3 = Student('Volkov', 'Dmitriy', 'male')
